...
enum FacilityLongevity
{
    ...
    FACILITY_LONGEVITY_JNI_CENTER       = FACILITY_LONGEVITY_LEVEL_0,
    FACILITY_LONGEVITY_RANDOM           = FACILITY_LONGEVITY_LEVEL_0,
    FACILITY_LONGEVITY_STD_ASYNC        = FACILITY_LONGEVITY_LEVEL_0,
    ...
    // Level 3
    FACILITY_LONGEVITY_ERROR            = FACILITY_LONGEVITY_LEVEL_3,
};
