...
enum FacilityLongevity
{
    ...
    // Level 0
    FACILITY_LONGEVITY_CHRONO  = FACILITY_LONGEVITY_LEVEL_0,

    // Level 1
    FACILITY_LONGEVITY_TRACE   = FACILITY_LONGEVITY_LEVEL_1,
    
    // Level 2
    FACILITY_LONGEVITY_SPRINTF = FACILITY_LONGEVITY_LEVEL_2,
};
